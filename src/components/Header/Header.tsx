...
export default function Header() {
  ...
  <Link href='/' className='transition-all duration-300 ease-in-out hover:text-zinc-300 hover:scale-105'>Home</Link>
            <Link href='/produtos' className='transition-all duration-300 ease-in-out hover:text-zinc-300 hover:scale-105'>Produtos</Link>
...
=======
            ...
            <Link href='/about' className='transition-all duration-200 ease-in-out hover:text-zinc-300 hover:font-medium'>Sobre</Link>
        </nav>
      </section>
