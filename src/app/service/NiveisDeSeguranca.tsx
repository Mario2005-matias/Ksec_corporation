      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-700">
          ...
          <div className="flex flex-col items-center justify-center px-4 py-6">
            ...
            <h3 className="font-bold text-center text-xl">Proteção Total</h3>
          ...
          <div className="flex flex-col items-center justify-center px-4 py-6">
            ...
            <h3 className="font-bold text-center  text-xl">Acesso Seguro</h3>
          ...
          <div className="flex flex-col items-center justify-center px-4 py-6">
            ...
            <h3 className="font-bold text-center text-xl">Detecção Avançada</h3>
          ...
          <div className="flex flex-col items-center justify-center px-4 py-6">
            ...
            <h3 className="font-bold text-center  text-xl">Monitoramento 24/7</h3>
